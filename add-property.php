...
if (strlen($_SESSION['remsuid'] == 0 || $_SESSION['ut'] == 3)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $ccolling = $_POST['centercolling']==""?0:1;
        $balcony = $_POST['balcony']==""?0:1;
        $petfrndly = $_POST['petfrndly']==""?0:1;
        $barbeque = $_POST['barbeque']==""?0:1;
        $firealarm = $_POST['firealarm']==""?0:1;
        $modkitchen = $_POST['modkitchen']==""?0:1;
        $storage = $_POST['storage']==""?0:1;
        $dryer = $_POST['dryer']==""?0:1;
        $heating = $_POST['heating']==""?0:1;
        $pool = $_POST['pool']==""?0:1;
        $laundry = $_POST['laundry']==""?0:1;
        $sauna = $_POST['sauna']==""?0:1;
        $gym = $_POST['gym']==""?0:1;
        $elevator = $_POST['elevator']==""?0:1;
        $dishwasher = $_POST['dishwasher']==""?0:1;
        $eexit = $_POST['eexit']==""?0:1;
        ...
        // echo "<pre>"; print_r($ccolling); exit;
...
//rename property images
            ...
            print_r($_FILES["featuredimage"]["tmp_name"]. "propertyimages/" . $propic);
            exit;
