...
if (isset($_POST['signup'])) {
    if ($_POST["vercodesignup"] != $_SESSION["vercode"] or $_SESSION["vercode"] == '') {
        ...
        if ($result > 0) {
            ...
            $query = mysqli_query($con, "INSERT INTO tbluser(FullName,Email,MobileNumber,Password,UserType,Aboutme) VALUES('$fname', '$email','$mobno', '$password','$usertype','$aboutme' )");
...
if (isset($_POST['signin'])) {
    // print_r($_SESSION["vercode"].'-'.$_POST["vercode"]); exit;
            ...
            <nav id="primary-menu" class="navbar navbar-fixed-top">
                ...
                <a class="logo" href="index.php">
                    ...
                    <div class="collapse navbar-collapse pull-right" id="navbar-collapse-1">
                        <ul class="nav navbar-nav nav-pos-center navbar-left" style="margin-left: 80px;">
                            <!-- Home Menu -->
                            <li>
                                                    ...
                                                    <div class="tab-pane" id="signup">
                                                        <form class="mb-0" method="post" name="signup">
                                                           ...
                                                           <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="text" class="form-control" name="aboutme" id="aboutme" required="true" placeholder="About me">
                                                            </div>
